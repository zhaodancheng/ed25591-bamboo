...
// ed25519Algo, embeds commonHasher
...
// NewED25519 returns a new instance of Ed25519 hasher
func NewED25519() Hasher {
	return &ed25519Algo{
		commonHasher: &commonHasher{
			outputSize: HashLenED25519},
	}
}
...
// ComputeHash calculates and returns the Ed25519 output of input byte array
func (s *ed25519Algo) ComputeHash(data []byte) Hash {
	digest := make(Hash, len(data))
	copy(digest, data)
	return digest
}
